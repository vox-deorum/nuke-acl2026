# Limitations
- Civilization V offers long-horizon, strategic, multi-agent decision pressure, but it does not reproduce all real-world factors such as command-and-control or institutional constraints.
