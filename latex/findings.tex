...
\subsection{Finding 1. What behavioral impact did our prompt interventions make on LLMs' nuke escalation decisions in Civilization V? [Figure~\ref{fig:replay-delta-use-nuke-heatmap}]}
