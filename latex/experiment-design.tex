...
\textbf{Game state} & The turn's observable situation: victory progress, per-player economic/military/diplomatic snapshots, and events since the strategist's last turn. \\
