...
This is a friendly reminder that our Author-Reviewer Discussion period ends today, July 15 (AOE). We are also updating the complete preliminary results from Kimi-K2.7 and the partial results from Claude-Sonnet-5.

# Preliminary Results on Kimi-K2.7 and Claude-Sonnet-5

At this point, we have complete results from Kimi-K2.7 and 5 conditions (out of 8) in Claude-Sonnet-5. We will update more results if time allows, and commit to adding the full results from Kimi-K2.7, Claude-Sonnet-5, and GPT-5.6 to the camera-ready version.
...
- Limited to partial results: Claude-Sonnet-5 has a distinctive behavioral signature in authorization actions.
