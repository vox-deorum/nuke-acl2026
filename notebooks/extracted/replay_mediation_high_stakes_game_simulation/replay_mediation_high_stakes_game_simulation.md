# `replay_mediation_high_stakes_game_simulation`

*Extracted from `replay_mediation_high_stakes_game_simulation.ipynb`*
...
```
Bootstrap samples valid by contrast: {'original -> high-stakes': 2000, 'no-rationale -> high-stakes-no-rationale': 2000, 'ethical -> ethical-high-stakes': 2000, 'ethical-no-rationale -> high-stakes-no-rationale-ethical': 2000}
```
