...
\caption{Ethical-prompting total effects versus mediator-controlled direct effects on \(\Delta\)\texttt{replay\_use\_nuke}, with the conditional outcome association of the explicit ethical reasoning indicator.}
...
\caption{High-stakes framing total effects versus mediator-controlled direct effects on \(\Delta\)\texttt{replay\_use\_nuke}, with the conditional outcome association of the simulation/game reasoning indicator.}
