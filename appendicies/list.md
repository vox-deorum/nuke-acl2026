...
| `app:deductive-code-regressions` | Deductive Code Regression Tables | Proposed stub | `latex/findings.tex` | Full joint and one-code regression tables for the 17 deductive reasoning codes; logistic regressions showing how prompt interventions reshape code prevalence. |
