...
This appendix provides the full codebook for the deductive coding procedure described in Section~\ref{sec:deductive-coding} and summarized in Section~\ref{sec:findings-deductive-reasoning}. Regression tables using these code indicators appear in Appendix~\ref{app:deductive-code-regressions}.
